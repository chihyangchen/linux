 ...
 */
static void
print_sys_cfg_ext_cap_len(void)
{
 ...
 */
static regdomain_e
region_string_2_region_code(t_u8 *region_string)
{
	t_u8 i;
 ...
 */
int
apcmd_sys_cfg_ext_cap_len(int argc, char *argv[])
{
	apcmdbuf_sys_configure *cmd_buf = NULL;
	...
	argv += optind;
	/* Check arguments */
	if (argc && (is_input_valid(AP_EXT_CAP_LEN, argc, argv) != UAP_SUCCESS)) {
		print_sys_cfg_ext_cap_len();
		return UAP_FAILURE;
	}
